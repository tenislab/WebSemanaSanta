...
--   33. vigilancia.sql                 Que los fallos se apunten solos: con cincuenta hermandades no te los cuenta nadie
--   34. canal-de-actualizacion.sql     Sacar una novedad a una hermandad piloto antes que a todas
--   35. restaurar-copia.sql            Poder volcar la copia de UNA hermandad sin tocar a las demás
--   36. soporte.sql                    Ver lo que ve esa hermandad para poder ayudarla, y que quede escrito
--   37. version-del-esquema.sql        Que la aplicación avise cuando la base se ha quedado atrás
--
-- -----------------------------------------------------------------------------
