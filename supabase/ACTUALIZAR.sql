...
--   21. tienda-web.sql                 La tienda en la web: reservar por internet y pagar al recoger
--   22. campanas-y-proyectos.sql       Campañas de recaudación con su barra, y proyectos a largo plazo
--   23. reglas-de-reparto.sql          Gastos porcentuales enlazados a una partida, para pérdidas y ganancias
--   24. pago-tarjeta.sql               Que el hermano pague su cuota o su papeleta con tarjeta
--
-- -----------------------------------------------------------------------------
