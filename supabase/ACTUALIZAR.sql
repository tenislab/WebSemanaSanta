...
--   31. vigilancia.sql                 Que los fallos se apunten solos: con cincuenta hermandades no te los cuenta nadie
--   32. canal-de-actualizacion.sql     Sacar una novedad a una hermandad piloto antes que a todas
--   33. restaurar-copia.sql            Poder volcar la copia de UNA hermandad sin tocar a las demás
--   34. soporte.sql                    Ver lo que ve esa hermandad para poder ayudarla, y que quede escrito
--   35. version-del-esquema.sql        Que la aplicación avise cuando la base se ha quedado atrás
--
-- -----------------------------------------------------------------------------
