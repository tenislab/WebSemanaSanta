...
--   51. campana-con-partida.sql    Enlazar una campaña a sus partidas: la barra se llena sola
--   52. reglas-de-reparto.sql      Gastos porcentuales enlazados a una partida, para pérdidas y ganancias
--   53. pago-tarjeta.sql           Que el hermano pague su cuota o su papeleta con tarjeta
--
-- -----------------------------------------------------------------------------
