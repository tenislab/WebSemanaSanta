...
select * from (
  ...
  from (values
    ...
    ('activar_suscripcion'),
    ('activar_suscripcion_por_usuario'),
    ('adoptar_datos_sin_hermandad'),
    ('cancelar_suscripcion_por_stripe'),
    ('canjear_recuperacion_hermano'),
    ('cobrar_pago_tarjeta'),
    ('crear_hermandad_manual'),
    ('crear_hermandad_manual_base'),
    ('datos_para_avisar_reserva'),
    ('fijar_sesion_pago'),
    ('limpiar_errores_cliente'),
    ('limpiar_registro_viejo'),
    ('limpiar_suscriptores_sin_confirmar'),
    ('limpiar_visitas_viejas'),
    ('llave_para_confirmar'),
    ('marcar_pago_fallido_por_stripe'),
    ('pedir_recuperacion_hermano'),
    ('renovar_suscripcion_por_stripe'),
