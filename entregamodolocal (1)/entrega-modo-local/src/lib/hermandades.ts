...
/**
 * Combina la hermandad principal con las de muestra para el buscador del
 * portal. Con Supabase conectado (modo real, un solo inquilino) las de
 * muestra NO aparecen: son escaparate del modo demostración, y en producción
...
export function directorioCompleto(principal: DatosHermandadPrincipal): HermandadDirectorio[] {
  return [
    ...
    ...(isSupabaseConfigured ? [] : HERMANDADES_MUESTRA),
  ]
}
